...
<Snippet
  file="AppMDX.jsx"
  caption="MDX Provider"
  expand
>
  I can't seem to get the MDX provider working with the bundled
  `SiteProvider`. If you want to use MDX pages then you'll have to add the
  `MDXProvider` yourself until I can figure out why it's not working out of
  the box.
</Snippet>
