...
The `BadgerPowered` component renders a link to the
<Link href="https://badgerpower.com/" text="https://badgerpower.com/"/> site
containing a badger icon and the word "Badger Powered". It's used in the default
site <Link to="/content/footer" code="Footer"/> component
